    ...
    <div id="maincontent" style="margin:20px;">
        <div id="productform">
            <form method="POST">
                ...
                <div class="col-md-4">
                    <label for="description" class="form-label">Ustaw opis</label>
                ...
                <input type="submit" value="Dodaj produkt" class="btn btn-success" style="margin-top:15px;">
                <p><small>Pola oznaczone * są wymagane</small></p>
            </form>
        </div>
        <div id="addproduct">
